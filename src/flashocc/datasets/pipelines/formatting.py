...
from flashocc.core.bbox.bbox import BaseInstance3DBoxes
from flashocc.core.bbox.points import BasePoints
from flashocc.datasets.pipelines.base import to_tensor
...
class Collect3D(object):
    ...
    Args:
        ...
        meta_keys (Sequence[str], optional): Meta keys to be converted to
            ``flashocc.DataContainer`` and collected in ``data[img_metas]``.
    ...
    def __call__(self, results):
        ...
        will be converted to :obj:`flashocc.DataContainer`.
